    ...
    <div className="w-full max-w-sm overflow-hidden bg-white dark:bg-neutral-900 rounded-lg hover:shadow-lg border border-gray-300 dark:border-[#FF204E]">
      ...
      <div className="px-6 py-4 ">
        ...
        <div className="flex items-center gap-3 mt-3">
          ...
          <h1 className="text-base text-black dark:text-neutral-100  font-semibold">{genre}</h1>
        </div>

        {/* Rating Section with Icon */}
        <div className="flex items-center gap-3 mt-3">
          <FcRating className="text-xl" /> {/* Rating Icon */}
          <p className="text-black dark:text-neutral-100  font-semibold text-lg">Rating:</p>
          <h1 className="text-base text-black dark:text-neutral-100  font-semibold">{rating}</h1>
        </div>
        ...
        <div className="flex items-center gap-3 mt-3">
          ...
          {/* Publish Year Icon */}
          <p className="text-black dark:text-neutral-100  font-semibold text-lg">Publish Year:</p>
          <h1 className="text-base text-black dark:text-neutral-100  font-semibold">
            {publishingYear}
          </h1>
        </div>
